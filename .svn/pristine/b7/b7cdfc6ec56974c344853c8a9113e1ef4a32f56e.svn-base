...
/**********************************************************************
   ...
   Module Description		: interface of GSensor.c
...
extern void GSensor_Interrupt_Handler(void);
extern void GSensor_gotoSleep(void);
extern void GSensor_getFIFO(uint8_t *data);
#ifdef CONFIG_G_SENSOR_UPLOAD
extern void GSensor_getHighG(uint8_t *data);
#endif
extern void GSensor_Read_Xyz_Value(void);
extern void Gsensor_check_data(void);

extern void Gsensor_Clear_Crank_Count(void);
extern uint16_t Gsensor_Get_Crank_Count(void);
extern void Gsensor_Clear_Shake_Count(void);
extern uint16_t Gsensor_Get_Shake_Count(void);
/*====================================================================================*\
