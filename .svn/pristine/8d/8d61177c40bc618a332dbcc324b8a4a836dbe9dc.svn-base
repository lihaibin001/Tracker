...
#define CONFIG_G_SENSOR_UPLOAD

/*
  * @brief  GSENSOR SPI Interface pins
  */  
#define GSENSOR_SPI						SPI2
#define GSENSOR_SPI_CLK					RCC_APB1Periph_SPI2
#define GSENSOR_SPI_SCK_PIN			GPIO_Pin_13                  /* PB.13 */
#define GSENSOR_SPI_SCK_GPIO_PORT		GPIOB                       /* GPIOB */
#define GSENSOR_SPI_SCK_GPIO_CLK		RCC_APB2Periph_GPIOB
#define GSENSOR_SPI_MISO_PIN			GPIO_Pin_14                  /* PB.14 */
#define GSENSOR_SPI_MISO_GPIO_PORT	GPIOB                       /* GPIOB */
#define GSENSOR_SPI_MISO_GPIO_CLK		RCC_APB2Periph_GPIOB
#define GSENSOR_SPI_MOSI_PIN			GPIO_Pin_15                  /* PB.15 */
#define GSENSOR_SPI_MOSI_GPIO_PORT	GPIOB                       /* GPIOB */
#define GSENSOR_SPI_MOSI_GPIO_CLK		RCC_APB2Periph_GPIOB
#define GSENSOR_CS_PIN					GPIO_Pin_12                  /* PB.12 */
#define GSENSOR_CS_GPIO_PORT			GPIOB                       /* GPIOB */
#define GSENSOR_CS_GPIO_CLK			RCC_APB2Periph_GPIOB

#define GSENSOR_INT1_PIN					GPIO_Pin_1                  /* PB.1 */
#define GSENSOR_INT1_GPIO_PORT			GPIOB                       /* GPIOB */


#define GSENSOR_INT1_ACTIVE()   GPIO_ReadInputDataBit(GSENSOR_INT1_GPIO_PORT, GSENSOR_INT1_PIN)
/* Select GSENSOR: Chip Select pin low   */
#define GSENSOR_CS_LOW()       GPIO_ResetBits(GSENSOR_CS_GPIO_PORT, GSENSOR_CS_PIN)
 /* Deselect GSENSOR: Chip Select pin high   */
#define GSENSOR_CS_HIGH()      GPIO_SetBits(GSENSOR_CS_GPIO_PORT, GSENSOR_CS_PIN)  
...
#define FS_MASK               0x03
//
#define FULL_SCALE_2G         0x00			//¡À0.244 mg/LSB
#define FULL_SCALE_4G         (FS0_MASK)	//¡À0.488 mg/LSB
#define FULL_SCALE_8G         (FS1_MASK)	//¡À0.976 mg/LSB
...
#define WAKE_A_VECM_MASK       0x04  //wake_en_a_vecm
...
#define INT_EN_FF_MT_MASK     0x04   //int_en_a_vecm
#define INT_EN_A_VECM_MASK     0x02   //int_en_a_vecm
...
#define INT_CFG_A_VECM_MASK     0x02   //vecm
...
#define A_VECM_ELE_MASK       0x40
#define A_VECM_INITM_MASK     0x20
#define A_VECM_UPDM_MASK      0x10
 ...
 *********************************************************************/
extern int16_t xAccel_mg;
extern int16_t yAccel_mg;
extern int16_t zAccel_mg;
/**********************************************************************
 * Global Function Prototypes
 *********************************************************************/
extern void Sensors_init(void);
//extern void Sensors_Interrupt_Handler(void);
extern void Sensors_gotoSleep(void);
extern void Sensors_getFIFO(uint8_t source, uint8_t *data);
extern void Sensor_Task(void* pvParameters);
#ifdef CONFIG_G_SENSOR_UPLOAD
extern void Sensors_getHighG(uint8_t source, uint8_t *data);
#endif
//extern void Sensors_Read_Xyz_Value(uint8_t source);
extern void Sensors_check_data(uint8_t source);
/*
extern void Sensors_Clear_Crank_Count(void);
extern uint16_t Sensors_Get_Crank_Count(void);
extern void Sensors_Clear_Shake_Count(void);
extern uint16_t Sensors_Get_Shake_Count(void);*/
/*====================================================================================*\
