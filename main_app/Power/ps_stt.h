...
TRANS (PS_EVT_OBD_ON,		CONDITION,		ps_check_obd_active)
TRANS (PS_EVT_OBD_ON,		INTERNAL,		no_action)
TRANS (PS_EVT_OBD_ON,		PS_USER_ON,	no_action)

TRANS (PS_EVT_IGN_ON,		CONDITION,		ps_check_obd_active_user_on)
TRANS (PS_EVT_IGN_ON,		INTERNAL,		no_action)
TRANS (PS_EVT_IGN_ON,		PS_USER_ON,	no_action)
...
TRANS (PS_EVT_OBD_ON_TMR_EXP, NEXT,	no_action)

TRANS (PS_EVT_OBD_OFF,	CONDITION,		ps_check_user_mode_condition)
TRANS (PS_EVT_OBD_OFF,	PS_AWAKE,		ps_set_force_user_off)
TRANS (PS_EVT_OBD_OFF,	PS_AWAKE,		ps_set_user_off_start_stdby_tmr)

TRANS (PS_EVT_ENG_ON,	PS_ENG_ON,		ps_stop_obd_on_tmr)
...
TRANS (PS_EVT_ENG_OFF,		PS_USER_ON,	no_action)
